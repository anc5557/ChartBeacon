"""
ChartBeacon quarterly indicators DAG
"""
...
dag = DAG(
    ...
    description="Calculate quarterly technical indicators",
    schedule_interval="0 23 1 1,4,7,10 *",  # 1st day of quarter 08:00 KST (23:00 UTC)
    catchup=False,
    max_active_runs=1,
    tags=["indicators", "3mo"],
)
